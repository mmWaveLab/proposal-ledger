...
- 主要用途: 用于实验室样机外壳、传感器支架、雷达/生理信号采集装置固定件、线缆整理件和结构验证件制作。
...
本次耗材以 PETG 为主。PETG 相比普通 PLA 具有更好的韧性、耐冲击性和一定耐温能力，适合制作需要反复拆装、承受线缆拉力和固定板卡的实验结构件。多种颜色耗材便于区分不同实验模块、不同样机版本和不同线缆路径；半透明材料适合观察内部走线、指示灯、接口位置和结构干涉情况；工程材料打印板与液体胶用于提高打印附着稳定性，减少打印失败和翘边。
...
| --- | ---: | ---: | ---: | --- |
| 拓竹 PETG Translucent 半透明 Light Blue | 1 | 50.51 | 50.51 | 下载截图价格 |
| 拓竹 PETG Basic 红色 | 1 | 38.99 | 38.99 | 下载截图价格 |
| 拓竹 PETG Basic 白色 | 1 | 38.99 | 38.99 | 下载截图价格 |
| 拓竹 PETG Basic 湖蓝色 | 1 | 38.99 | 38.99 | 下载截图价格 |
| 拓竹 PETG Basic 绿色 | 1 | 38.99 | 38.99 | 下载截图价格 |
| 拓竹 PETG Translucent Clear 透明 | 1 | 50.52 | 50.52 | 下载截图价格 |
| 工程材料打印板+液体胶 | 1 | 145.86 | 145.86 | 下载截图价格 |
| 合计 |  |  | 402.85 | 商品截图记录价 |
...
- 半透明材料便于观察内部走线、状态指示灯和结构干涉情况，适合调试阶段样机。
