...
本项目拟购置 Radxa Cubie A5E 数据采集套件，核心为 Cubie A5E 商业级 A527 SoC / 4GB 内存版本，并配套 Radxa Camera 4K 摄像头模块和 Radxa Power PD 30W 电源适配器。该套件作为双网口数据采集边缘主控平台，用于多设备数据接入、网络隔离、视觉辅助采集、边缘缓存与转发。官方资料显示，Cubie A5E 可选全志 A527 SoC 或工业级 T527 SoC，搭载 8 核 Arm Cortex-A55 CPU；A527 版本支持 LPDDR4/LPDDR4x 内存、microSD/eMMC/M.2 NVMe 存储、2 个千兆以太网口、Wi-Fi 6、蓝牙 5.4、USB 3.0、USB Type-C OTG、40 Pin GPIO，以及 M.2 M Key 2230 扩展。
...
| --- | ---: | ---: | ---: | --- |
| Radxa Cubie A5E 4GB 商业级迷你主板 | 1 | 0 | 0 | A527 SoC，淘宝商品 ID `871582539578`，实时价格待人工确认 |
| Radxa Camera 4K 摄像头模块 | 1 | 0 | 0 | MIPI CSI 摄像头，用于现场画面和视觉辅助采集 |
| Radxa Power PD 30W 电源适配器 | 1 | 0 | 0 | 官方兼容电源，提供稳定 30W 供电 |
| M.2 2230 NVMe SSD | 1 | 0 | 0 | 可选扩展项，用于边缘缓存；如已有库存可删去 |
| 合计 |  |  | 0 | 价格确认后填写 |
